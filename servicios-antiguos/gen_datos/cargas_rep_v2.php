...
/// este script ingresa datos de planta magnetica a la base de datos de c2 y a la base de datos del reporte diario para la generacion del reporte
  ...
  $mhora = date('H:i');
   ...
   '5730_PU0002.status.TotalCurrent','5730_PU0003.status.TotalCurrent','5730_PU0004.status.TotalCurrent','FIT1301.IO.Value','FIT2301.IO.Value',
	  'WIT0303.IO.Value',
		...
		)and DateTime BETWEEN DateAdd(mi,-10,GetDate()) and GetDate() GROUP BY TagName";
...
/// bd 2---------------------------------------------------------------------------
	...
	$p5841_CB120_WIT = (int)$jsondecode["WIT841_002.IO.Value"];
	...
	$bm1001_pow = $jsondecode["5740_BM1001.M101_POW"];
	$bm1002_pow = $jsondecode["5740_BM1002.M101_POW"];
	$bm2001_pow = $jsondecode["5740_BM2001.M101_POW"];
	$bm2002_pow = $jsondecode["5740_BM2002.M101_POW"];
	$flujo_desaladora = $jsondecode["N1920_FIT0001.IO.Value"];
...
array_push($post_data,$row_data_l1);
	$row_data_l2-> linea = 2;	
