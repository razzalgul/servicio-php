...
function conexion()
{
    ...
    $serverName = "172.16.12.51"; //gr_history
    //$serverName = "172.16.0.72";  //gr
    //$connectionOptions = array(“Database” => “Runtime”);  // otro master
    $connectionOptions = array("Database" => "Runtime", "Uid" => "wsuser", "PWD" => "ccr.ADMIN2027", "MultipleActiveResultSets" => 0,"TrustServerCertificate"=>true);
...
co::run(function () {
    ...
    echo "mensaje de bienvenida es".$recibido;
    $cli_internet->push(json_encode($data_registro));
    $recibido = $cli_internet->recv(3);
    echo "mensaje de registro ".$recibido;
    co::sleep(1);
    $intento = 0;
    ...
    while ($cli_internet){
        ...
        if (strpos($recibido, "mensaje")) {
            ...
            echo "no se tiene respuesta del servidor, reconectando";
            break 1;
        } 
        co::sleep(1);
    }
