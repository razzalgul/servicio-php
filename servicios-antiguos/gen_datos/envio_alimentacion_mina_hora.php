...
$queryPrev = "SELECT Value FROM Runtime.dbo.AnalogHistory WHERE TagName = 'WCT5841WE120_002.Value' AND DateTime = '$prevHourDate'";
...
if ($currentValue !== null && $previousValue !== null) {
    ...
    echo "Advertencia: No se encontró valor actual o histórico para WCT5841WE120_002.Value. Enviando 0." . PHP_EOL;
}
